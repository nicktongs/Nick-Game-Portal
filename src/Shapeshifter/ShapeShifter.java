...
public class ShapeShifter extends PApplet implements GameWriteable {
...
void drawWinGradientBackground() {
  int c1 = color(70, 230, 255);
  int c2 = color(255, 240, 90);
...
public void play() {
    ...
    PApplet.runSketch(new String[] { "ShapeShifter" }, this);
    ...
    System.out.println("ShapeShifter ended. Final score = " + score);
    writeHighScore(new File("Highscore.csv"));
    System.out.println("ShapeShifter high score write attempted.");
}
